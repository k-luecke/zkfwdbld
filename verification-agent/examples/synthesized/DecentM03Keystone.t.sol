...
contract DecentM03Keystone is VerifyGate {
    ...
    function caseId() public pure override returns(string memory){return "M03_keystone_deploygraph_plus_synth_signature__CALIBRATION";}
    ...
    // MACHINE-SYNTHESIZED signer for scheme=eip191_personal_sign
